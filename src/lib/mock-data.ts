...
export const mockProviderData: Record<string, ServiceProvider> = {
    'srv1': {
        id: 'srv1',
        name: 'Quick Plumbers',
        service: 'Plumbing',
...
export const mockClinicData: Record<string, Clinic> = {
  'clinic1': {
      id: 'clinic1',
...
export const mockInsuranceData: Record<string, InsuranceProvider> = {
  'ins1': {
      id: 'ins1',
